...
func TestMarshalPayload(t *testing.T) {
	...
	if err := MarshalPayload(out1, book, nil); err != nil {
		t.Fatalf("marshal one payload: %v", err)
	}
	...
	if err := MarshalPayload(out2, books, nil); err != nil {
		t.Fatalf("marshal many payload: %v", err)
	}
...
func TestMarshalPayloadWithNulls(t *testing.T) {
	...
	if err := MarshalPayload(out, books, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshal_attrStringSlice(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, b, nil); err != nil {
		t.Fatal(err)
	}
	...
	for i, tag := range tags {
		if len(jsonTagsStrings)-1 >= i { // Panic insurance
			if e, a := tag, jsonTagsStrings[i]; e != a {
				t.Fatalf("At index %d, was expecting %s got %s", i, e, a)
			}
		} else {
			t.Errorf("expected index %d to exist in jsonTagsStrings, did not", i)
		}
	}
}
...
func TestWithoutOmitsEmptyAnnotationOnRelation(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, blog, nil); err != nil {
		t.Fatal(err)
	}
...
func TestWithOmitsEmptyAnnotationOnAttribute(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, author, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalIDPtr(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, car, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalOnePayload_omitIDString(t *testing.T) {
	...
	foo := &Foo{Title: "Foo"}
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, foo, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshall_invalidIDType(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, o, nil); err != ErrBadJSONAPIID {
		t.Fatalf(
...
func TestOmitsEmptyAnnotation(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, book, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalPayloadWithoutIncluded(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayloadWithoutIncluded(out, data, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalPayload_many(t *testing.T) {
	...
	out := bytes.NewBuffer(nil)
	if err := MarshalPayload(out, data, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshalMany_SliceOfInterfaceAndSliceOfStructsSameJSON(t *testing.T) {
	...
	if err := MarshalPayload(structsOut, structs, nil); err != nil {
		t.Fatal(err)
	}
	interfacesOut := new(bytes.Buffer)
	if err := MarshalPayload(interfacesOut, interfaces, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshal_InvalidIntefaceArgument(t *testing.T) {
	...
	if err := MarshalPayload(out, true, nil); err != ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
	if err := MarshalPayload(out, 25, nil); err != ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
	if err := MarshalPayload(out, Book{}, nil); err != ErrUnexpectedType {
		t.Fatal("Was expecting an error")
	}
}
...
func TestMarshal_SkipField(t *testing.T) {
	...
	var b bytes.Buffer
	if err := MarshalPayload(&b, &f, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMarshal_TopLevelLinks(t *testing.T) {
	type Foo struct {
		ID  string `jsonapi:"primary,foo"`
		Baz string `jsonapi:"attr,baz"`
	}
	...
	testLink := "www.test.com/topLevelLink"
	tll := &Links{
		"test": testLink,
	}

	var b bytes.Buffer
	if err := MarshalPayload(&b, foos, tll); err != nil {
		t.Fatal(err)
	}

	if idx := strings.Index(b.String(), testLink); idx == -1 {
		t.Fatal("expected to find added top level link, did not")
	}
}
